...
async def on_message(message):
    ...
    if "Gold Experience" in (role.name for role in message.author.roles):
        if "Requiem" in (role.name for role in message.author.roles):
            get_zero = message.author.id
            
    if "Star Platinum" in (role.name for role in message.author.roles):
        get_plat = message.author.id
        
    if message.content.startswith('~'):
        if "В муте" not in (role.name for role in message.author.roles):
            if message.author.id != zeroed:
                if get_zero != "":
                    if "{}".format(get_zero) in message.content:
                        get_zeroed = discord.Server.get_member(message.server, user_id=get_zero)
                        if "Gold Experience" in (role.name for role in get_zeroed.roles):
                            if "Requiem" in (role.name for role in get_zeroed.roles):
                                embed = discord.Embed(title = "**{}** был обнулён.".format(message.author.name), description = "*{} теперь не сможет юзать бота.*".format(message.author.name), color = 0xffff00)
                                embed.set_image(url="https://cdn.discordapp.com/attachments/470567218497847296/482429308791554079/unknown.png")
                                await bot.send_message(message.channel, embed=embed)
                
                                zeroed = message.author.id
                            
    if message.content.startswith('~'):
        if "В муте" not in (role.name for role in message.author.roles):
            if "{}".format(get_plat) in message.content:
                get_plated = discord.Server.get_member(message.server, user_id=get_plat)
                if "Star Platinum" in (role.name for role in get_plated.roles):
                    embed = discord.Embed(title = "ORA ORA ORA, {}!".format(message.author.name), description = "*«ОРА ОРА ОРА, {}!»*".format(message.author.name), color = 0xffff00)
...
async def info(ctx):
    ...
    #5 ЧАСТЬ
        ...
        embed = discord.Embed(title = "Информация о вашем стенде:", description = "Имя стенда: ``Застёжник``\nВладелец стенда: ``{}``\nСпособности стенда:\n``Пассивка: каждое сообщение от вас в застёжке - мут на 5 секунд``\n``~zip - сделать застёжку``\n``~zipper - ARIARIARI``".format(ctx.message.author.name), color = 0xffff00)
        embed.set_image(url="https://cdn.discordapp.com/attachments/473403386599964672/492351022858108928/unknown.png")
        await bot.send_message(ctx.message.channel, embed=embed)
        ...
        await bot.send_message(ctx.message.channel, embed=embed)
    elif "Aerosmith" in (role.name for role in ctx.message.author.roles): #Мелкий бомбитель
        embed = discord.Embed(title = "Информация о вашем стенде:", description = "Имя стенда: ``Мелкий бомбитель``\nВладелец стенда: ``{}``\nСпособности стенда:\n``~aero (юзер 1) (юзер 2) - атаковать 2 пользователей, во время атаки нельзя пользоваться ботом``".format(ctx.message.author.name), color = 0xffff00)
        embed.set_image(url="https://cdn.discordapp.com/attachments/470567218497847296/489843320151998483/3.PNG")
        await bot.send_message(ctx.message.channel, embed=embed)
    elif "Purple Haze" in (role.name for role in ctx.message.author.roles): #ФТ
        embed = discord.Embed(title = "Информация о вашем стенде:", description = "Имя стенда: ``Фиолетовый Дым``\nВладелец стенда: ``{}``\nСпособности стенда:\n``Пассивка: иногда стенд может потерять контроль и атаковать другую цель. Кроме того, если кто-нибудь не вылечит вирус через 2 минуты, пользователь попадёт в мут.``\n``~ubasha - замутить на 6 секунд``\n``~virused - заразить кого-нибудь``".format(ctx.message.author.name), color = 0xffff00)
        embed.set_image(url="https://cdn.discordapp.com/attachments/473403386599964672/487280636667756545/unknown.png")
        await bot.send_message(ctx.message.channel, embed=embed)
    ...
    if "Atom Heart Father" in (role.name for role in ctx.message.author.roles): #ОТЕЦ
...
async def divine(ctx, member : discord.Member):
    ...
    #5 ЧАСТЬ
        ...
        embed = discord.Embed(title = "Информация о стенде:", description = "Имя стенда: ``Застёжник``\nВладелец стенда: ``{}``\nСпособности стенда:\n``Пассивка: каждое сообщение от вас в застёжке - мут на 5 секунд``\n``~zip - сделать застёжку``\n``~zipper - ARIARIARI``".format(member.name), color = 0xffff00)
        embed.set_image(url="https://cdn.discordapp.com/attachments/473403386599964672/492351022858108928/unknown.png")
        await bot.send_message(ctx.message.channel, embed=embed)
        ...
        await bot.send_message(ctx.message.channel, embed=embed)
    elif "Aerosmith" in (role.name for role in member.roles): #2Мелкий бомбитель
        embed = discord.Embed(title = "Информация о стенде:", description = "Имя стенда: ``Мелкий бомбитель``\nВладелец стенда: ``{}``\nСпособности стенда:\n``~aero (юзер 1) (юзер 2) - атаковать 2 пользователей, во время атаки нельзя пользоваться ботом``".format(member.name), color = 0xffff00)
        embed.set_image(url="https://cdn.discordapp.com/attachments/470567218497847296/489843320151998483/3.PNG")
        await bot.send_message(ctx.message.channel, embed=embed)
    elif "Purple Haze" in (role.name for role in member.roles): #2ФТ
        embed = discord.Embed(title = "Информация о стенде:", description = "Имя стенда: ``Фиолетовый Дым``\nВладелец стенда: ``{}``\nСпособности стенда:\n``Пассивка: иногда стенд может потерять контроль и атаковать другую цель. Кроме того, если кто-нибудь не вылечит вирус через 2 минуты, пользователь попадёт в мут.``\n``~ubasha - замутить на 6 секунд``\n``~virused - заразить кого-нибудь``".format(member.name), color = 0xffff00)
        embed.set_image(url="https://cdn.discordapp.com/attachments/473403386599964672/487280636667756545/unknown.png")
        await bot.send_message(ctx.message.channel, embed=embed)
    elif "Spice Girl" in (role.name for role in member.roles): #2SG
        embed = discord.Embed(title = "Информация о стенде:", description = "Имя стенда: ``Спайс Гёрл``\nВладелец стенда: ``{}``\nСпособности стенда:\n``~soft - замутить на 3 секунды и забрать возможность один раз воспользоваться стендом``".format(member.name), color = 0xffff00)
        embed.set_image(url="https://vignette.wikia.nocookie.net/jjba/images/d/df/Spice_Girl.png/revision/latest/scale-to-width-down/350?cb=20160413153303")
        await bot.send_message(ctx.message.channel, embed=embed)
    ...
    if "Atom Heart Father" in (role.name for role in member.roles): #2ОТЕЦ
...
async def rofl(ctx):
    ...
    if "Roflan Crusader" in (role.name for role in ctx.message.author.roles):
        if "Requiem" in (role.name for role in ctx.message.author.roles):
            randomebalo = ['<:roflanEbalo:492419155375685632>', '<:roflanPride:492422719262949398>', '<:fedorAhuelEbalo:464441709070385182>', '<a:roflanLUL:478437941967060993>']
        elif "Over Heaven" in (role.name for role in ctx.message.author.roles):
            randomebalo = ['<:roflanEbalo:4924191553756856327>', '<:roflanPride:492422719262949398>', '<:fedorAhuelEbalo:464441709070385182>', '<a:roflanLUL:478437941967060993>']
        else:
            randomebalo = ['<:roflanEbalo:492419155375685632>', '<:roflanPride:492422719262949398>', '<:fedorAhuelEbalo:464441709070385182>']
...
async def glife(ctx, member : discord.Member):
    ...
    global virus_S
    if "Gold Experience" in (role.name for role in ctx.message.author.roles):
        embed = discord.Embed(title = "**GORUDO EXPERIENCU NO NORI OKU**.".format(ctx.message.author.name, member.name), description = "*{} создал жизнь в {}*".format(ctx.message.author.name, member.name), color = 0xffff00)
        ...
        if "В муте" in (role.name for role in member.roles):
            ...
            embed.set_image(url="https://cdn.discordapp.com/attachments/473403386599964672/492347672553062420/unknown.png")
            await bot.send_message(ctx.message.channel, embed=embed)
...
async def zip(ctx, member : discord.Member):
    ...
    if "Sticky Fingers" in (role.name for role in ctx.message.author.roles):
        ...
        embed.set_image(url="https://cdn.discordapp.com/attachments/473756396295290890/492349915121319946/unknown.png")
        await bot.send_message(ctx.message.channel, embed=embed)
...
async def zipper(ctx, member : discord.Member):
    ...
    if "Sticky Fingers" in (role.name for role in ctx.message.author.roles):
        ...
        embed.set_image(url="https://media.giphy.com/media/cAgyiFUcqYal9TXKQY/giphy.gif")
        await bot.send_message(ctx.message.channel, embed=embed)
...
async def aero(ctx, member : discord.Member, smember : discord.Member):
    ...
    if "Aerosmith" in (role.name for role in ctx.message.author.roles):
        ...
        if random.randint(0, 3) == 1:
            embed = discord.Embed(title = "VOLAVOLAVOLA, **{}**, **{}**.".format(member.name, smember.name), description = "*... VOLARE VIA!* **Мут на 10 минут**".format(ctx.message.author.name), color = 0xffff00)
            embed.set_image(url="https://media.giphy.com/media/28JHwxyQYQsHWWkylD/giphy.gif")
            await bot.send_message(ctx.message.channel, embed=embed)
            ...
            embed.set_image(url="https://cdn.discordapp.com/attachments/470567218497847296/489840401457610772/2.PNG")
            await bot.send_message(ctx.message.channel, embed=embed)
            aero = 0
            ...
            embed = discord.Embed(title = "VOLAVOLAVOLA, **{}**, **{}**.".format(member.name, smember.name), description = "*... VOLARE VIA!* **Мут на 5 минут**".format(ctx.message.author.name), color = 0xffff00)
            embed.set_image(url="https://media.giphy.com/media/63LRF6ooWfHUtnCOph/giphy.gif")
            await bot.send_message(ctx.message.channel, embed=embed)
            ...
            embed = discord.Embed(title = "**{}** и **{}** размучены.".format(member.name, smember.name), description = "*{} снова может юзать бота.*".format(ctx.message.author.name), color = 0xffff00)
            embed.set_image(url="https://cdn.discordapp.com/attachments/470567218497847296/489840401327325205/e3a8b696f018381d.PNG")
            await bot.send_message(ctx.message.channel, embed=embed)
            aero = 0
...
async def virused(ctx, member : discord.Member):
    ...
    if "Purple Haze" in (role.name for role in ctx.message.author.roles):
        ...
        for member in ctx.message.server.members:
            list_of.append(member)
            
        xy = random.choice(list_of)
        
        if random.randint(0, 3) == 1:
        
            if random.randint(0, 2) == 1:
                embed = discord.Embed(title = "**{}** заразил вирусом **{}**.".format(ctx.message.author.name, xy.name), description = "**Стенд потерял контроль и случайно заразил вирусом не того.**", color = 0xffff00)
                embed.set_image(url="https://cdn.discordapp.com/attachments/473403386599964672/487280196450385932/unknown.png")
                await bot.send_message(ctx.message.channel, embed=embed)
                ...
                if virus_S != 0:
                    ...
                    if virus_S != 0:
                        ...
                        if virus_S != 0:
                            ...
                            virus = ""
                            mute_role = discord.utils.find(lambda r: r.name == 'В муте', ctx.message.server.roles)
                            await bot.add_roles(xy, mute_role)
            else:
            
                embed = discord.Embed(title = "**{}** заразил вирусом себя.".format(ctx.message.author.name), description = "**Стенд потерял контроль и случайно заразил вирусом не того.**", color = 0xffff00)
                embed.set_image(url="https://cdn.discordapp.com/attachments/473403386599964672/487280196450385932/unknown.png")
                await bot.send_message(ctx.message.channel, embed=embed)
                
                virus = ctx.message.author.id
                virus_S = 0
...
async def setstandname(ctx, *args):
    ...
    if "Made in Heaven" in (role.name for role in ctx.message.author.roles):
        if "Requiem" in (role.name for role in ctx.message.author.roles):
            sutand_name = ' '.join(args)
            role_check = discord.utils.find(lambda r: r.name == sutand_name, ctx.message.server.roles)
            
            if ctx.message.server.name == "TheOneTranslator":
                if role_check is not None:
                    await bot.send_message(ctx.message.channel, "``Ты сука иди на хуй.``")
                    return
...
async def ubasha(ctx, member : discord.Member):
    ...
    if "Purple Haze" in (role.name for role in ctx.message.author.roles):
        ...
        if random.randint(0, 3) == 1:
            embed = discord.Embed(title = "UBASHAAAA, {}!".format(ctx.message.author.name), description = "*«УБАШАААА, {}!»* **Стенд взбесился и атаковал не ту цель.**".format(ctx.message.author.name), color = 0xffff00)
            embed.set_image(url="https://cdn.discordapp.com/attachments/473403386599964672/487280196450385932/unknown.png")
            await bot.send_message(ctx.message.channel, embed=embed)
            ...
            embed = discord.Embed(title = "UBASHAAAA, {}!".format(xy.name), description = "*«УБАШАААА, {}!»* **Стенд взбесился и начал атаковать всех подряд.**".format(xy.name), color = 0xffff00)
            embed.set_image(url="https://cdn.discordapp.com/attachments/473403386599964672/487280196450385932/unknown.png")
            await bot.send_message(ctx.message.channel, embed=embed)
            ...
            mute_role = discord.utils.find(lambda r: r.name == 'В муте', ctx.message.server.roles)
            await bot.remove_roles(xy, mute_role)
            ...
            xy = random.choice(list_of)
            embed = discord.Embed(title = "UBASHAAAA, {}!".format(xy.name), description = "*«УБАШАААА, {}!»* **Стенд успокоился и перестал атаковать.**".format(xy.name), color = 0xffff00)
            embed.set_image(url="https://cdn.discordapp.com/attachments/473403386599964672/487280196450385932/unknown.png")
            await bot.send_message(ctx.message.channel, embed=embed)
