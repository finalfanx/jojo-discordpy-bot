...
async def rofl(ctx):
    ...
    if "Roflan Crusader" in (role.name for role in ctx.message.author.roles):
        if "Requiem" in (role.name for role in ctx.message.author.roles) or "Over Heaven" in (role.name for role in ctx.message.author.roles):
            randomebalo = ['<:roflanEbalo:492419155375685632>', '<:roflanPride:492422719262949398>', '<:BotAhuelEbalo:492419607215472640>', '<a:roflanLUL:478437941967060993>']
        else:
            randomebalo = ['<:roflanEbalo:492419155375685632>', '<:roflanPride:492422719262949398>', '<:BotAhuelEbalo:492419607215472640>']
